  ...
  try {
    ...
    return [
      ...
      },
      {
        ...
        address:
          "1350-1352 Rizal Ave Extn ( between 6th & 7th Ave.), Brgy. 110 Gracepark, Caloocan City 1400",
        latitude: 14.6460235,
      ...
      },
      {
        ...
        address:
          "Unit 1 Ground Floor, Aryanna Village Center, Brgy 175, Susano Road, Camarin, Caloocan City 1400",
        latitude: 14.7559063,
      ...
      },
      {
        ...
        address:
          "MCU Compound, EDSA Monumento, Barangay 84, Caloocan City 1400",
        latitude: 14.6574292,
  ...
  useEffect(() => {
    ...
    fetchBranchData().then((data) => {
      ...
      setDisplayedBranches(
        branchesWithCoordinates.slice(0, visibleBranchCount)
      );
    });
  }, []);
    ...
    <div className="branches-page">
      ...
      <div className="branches-content">
        <div className="branches-container branches-redesign">
          ...
          <div
            className={`map-section ${isListCollapsed ? "list-collapsed" : ""}`}
          >
            ...
            <div className="map-content">
                ...
                {!isListCollapsed && (
                  ...
                  >
                    <BranchList
                      ...
                      hasMore={
                        displayedBranches.length < filteredBranches.length
                      }
                    />
                  </motion.div>
                )}
              ...
              <button
                className={`collapse-toggle-btn list-toggle ${
                  isListCollapsed ? "collapsed" : ""
                }`}
                onClick={toggleListCollapse}
                aria-label={
                  isListCollapsed ? "Show branch list" : "Hide branch list"
                }
              >
                {isListCollapsed ? (
          ...
          <AnimatePresence>
            {selectedBranch && (
              <motion.div
                className={`branch-details-section ${
              ...
              >
                ...
                <button
                  className={`collapse-toggle-btn details-toggle ${
